public class Heros extends Personnage {
    ...
    public String attaqueMagique() {
        if (mana >= 20) { // Coût de l'attaque magique
           mana -= 20; // Déduit le coût du mana
            ...
            return nom + " utilise une attaque magique! Dégâts infligés: " + ((forceAttaque) + 1* 2); // Dégâts de l'attaque magique
        } else {
    ...
    private void rechargerMana() {
        ...
        System.out.println(nom + " recharge son mana! Mana actuel: " + mana);
    }
}